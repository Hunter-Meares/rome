...
WELCOME_MAIL_BODY = (
    ...
    "Not everyone comes to Rome to fight. If you'd rather never draw "
    "a blade at all, 'help pacifism' explains a real, permanent way "
    "to opt out of combat entirely - and you can request it right "
    "now, before you've done anything else.\n\n"
