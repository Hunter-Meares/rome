...
def create_all_help_entries():
    ...
    newbie_entry = HelpEntry.objects.create(
        ...
        db_entrytext=(
            ...
            "from level 1 without ever touching combat.\n\n"
    ...
    HelpEntry.objects.create(
        ...
        db_entrytext=(
            ...
            "armor again afterward either - a pacifist has laid down "
            "arms permanently, not just for the moment. Purely "
            "cosmetic, zero-protection clothing still works fine - "
            "see the tailor at Cloth Merchants and Tailors (the "
            "Forum) if you want something other than an empty chest "
            "slot.\n\n"
