...
def create_all_help_entries():
    ...
    newbie_entry = HelpEntry.objects.create(
        ...
        db_entrytext=(
            ...
            "fighting - gather iron ore at the Germanic Stronghold's "
            "Ore Vein Shaft and timber from Rome's own wilderness "
            "roads, then forge your first item for free at the Smithy "
            "('help faber'). Or gather healing herbs from that same "
            "wilderness and brew a free tonic at the apothecary's "
            "mortar in Market Row - Back Stalls ('help herbalist'). "
            "Either is a real, repeatable way to earn gold and level "
            "from level 1 without ever touching combat. (A pacifist "
            "can only wear clothing, not armor - the tailor at Cloth "
            "Merchants and Tailors in the Forum sells it; see 'help "
            "pacifism'.)\n\n"
    ...
    HelpEntry.objects.create(
        ...
        db_entrytext=(
            ...
            "|wYou give up your gear to do this, for good.|n Every "
            "weapon and piece of armor you're wearing comes off the "
            "moment you confirm - anything one of a kind is destroyed "
            "outright, not merely dropped. Ordinary gear isn't "
            "destroyed, but you can't wield a weapon or wear real "
            "armor or a shield again afterward either - a pacifist has "
            "laid down arms permanently, not just for the moment.\n\n"
            "|wWhat you can wear instead: clothing.|n A pacifist can "
            "only wear clothing - items that offer no protection at "
            "all. Some shops in Rome sell it: the tailor, Vibia, at "
            "Cloth Merchants and Tailors (in the Forum's commercial "
            "district) sells plain robes and tunics. She'll tell you "
            "herself they won't stop a blade - that's the point, and "
            "it's all a pacifist can put on a chest slot. Anything "
            "that gives no real protection, like a simple cap, "
            "gloves, or boots, is fine to wear too.\n\n"
    ...
    HelpEntry.objects.create(
        ...
        db_entrytext=(
            ...
            "or healing herbs (either can turn up on the same wooded "
            "tile - it's random which one a given visit offers), the "
            "Ore Vein Shaft complex (off the Germanic Stronghold's "
            "Smithy) for iron ore. Walking in is never a guarantee, "
            "though - you'll get a real message the moment something "
            "is actually there to take ('You spot...'), so keep "
            "exploring if a particular spot comes up empty. A pacifist "
            "('help pacifism') gathers in total safety everywhere - no "
            "wilderness encounter ever spawns for one. Anyone else "
            "gathering on the wilderness road itself is still exposed "
            "to that road's own random encounters, same as just "
            "walking it.\n\n"
            "|wCommon vs. rare:|n timber and herbs are both common and "
            "refresh for you in a few minutes; iron ore is rare and "
            "refreshes for you roughly once a day - worth the trip, not "
            "something to farm repeatedly in one sitting. Either way, "
            "once you've actually gathered somewhere, you personally can "
    ...
    HelpEntry.objects.create(
        ...
        db_entrytext=(
            ...
            "commands ('craft', 'recipes', 'learnrecipe').\n\n"
            "|wGathering:|n healing herbs grow wild, not in a market - "
            "look for them the same way you'd look for timber, off-road "
            "in Rome's own forested wilderness (the road toward the "
            "Germanic Stronghold). See 'help gathering'.\n\n"
            "|wCrafting:|n every Herbalist recipe needs the apothecary's "
            "mortar at Market Row - Back Stalls (the Subura) - it's a "
            "fixture, not something you carry, so you have to actually "
            "be standing there to brew, even though the herbs "
            "themselves came from somewhere else entirely.\n\n"
    ...
    HelpEntry.objects.create(
        ...
        db_entrytext=(
            ...
            "|wWhat it does:|n every food and drink does something. Most "
            "restore some HP or SP - a meat pie a lot, roasted nuts a little "
            "(nuts and honeyed bread are mostly stamina, meat and bread mostly "
            "health) - and some give a short-lived bonus instead or on top: "
            "hard cheese steadies your defense, spiced nuts sharpen your aim, "
            "Falernian wine puts fight into you, fortified wine calms fear. If "
            "it would only restore something you're already full on, it stays "
            "uneaten so nothing is wasted. A drink with several servings (an "
            "amphora) lasts a few sips.\n\n"
