...
def menunode_welcome(caller):
    ...
    text = dedent(
        ...
        This is the starting node for all brand new characters. Players are free
        to exit the character creator and resume later.
...
def menunode_categories(caller, **kwargs):
    ...
    text = dedent(
        ...
        Some other character attributes.
        """
    )
