...
CLASSES = {
    "augur": {
        ...
        "gear_desc": "Light robe, ritual staff, small amulet",
        "stat_mods": {"virtus": 0, "agilitas": 0, "ingenium": 3, "vigor": 0},
        "starting_gear": ["RITUAL_STAFF"],
    ...
    "medicus": {
        ...
        "gear_desc": "Satchel of herbs and bandages, a simple probe, a field tunic",
        "stat_mods": {"virtus": 0, "agilitas": 0, "ingenium": 2, "vigor": 1},
        "starting_gear": ["DAGGER"],
    ...
    "haruspex": {
        ...
        "gear_desc": "Light ritual garb, sacrificial blade (ceremonial), bone talismans",
        "stat_mods": {"virtus": 0, "agilitas": 0, "ingenium": 3, "vigor": 0},
        "starting_gear": ["DAGGER"],
    ...
    "barbarian": {
        ...
        "gear_desc": "Heavy hide or mixed plate, two-handed axe or maul, war necklace",
        "stat_mods": {"virtus": 3, "agilitas": 0, "ingenium": 0, "vigor": 0},
        "starting_gear": ["GREATSWORD"],
        "starting_spells": [],
